...
アニメーションと競合している場合は、[ベイクモード](/guide/bake)で対応できます。アニメーション側で破綻が起きている場合も、ベイクモードで破綻を軽減できます。
:::
...
- [ベイクモード](/guide/bake) … 表情アニメーションと競合しているとき。アニメーションで破綻が起きている場合も、破綻を軽減できます（→ [通常モードとの違い](/guide/bake-vs-normal)）
